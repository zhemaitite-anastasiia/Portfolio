...
<head>
	<meta charset="utf-8">
	<title>jQuery-svg-progress | by Alexander Tsymbaluk</title>
...
<body>	
	...
	<main>
		...
		<div id="jQuery-svg-progress">
			<div class="container">
				<div class="row">

					<div class="col-md-12 mb4 demo-wrap">
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-8">
									<div class="svg-progress-demo1 demo-item big" data-progress-value="100">
										<span class="svg-progress-output"></span>
									</div>
									<div class="svg-progress-demo1 demo-item normal" data-progress-value="73">
										<span class="svg-progress-output"></span>
									</div>
									<div class="svg-progress-demo1 demo-item small" data-progress-value="53">
										<span class="svg-progress-output"></span>
									</div>
								</div>
								<div class="col-md-4">
									<h2 class="title-plagin">Hexagon <br> proggres example</h2>
									<div class="buttons-wrap mt2">
										<button type="button" class="btn start">start</button>
										<button type="button" class="btn reverse">reverse</button>
					...
					<div class="col-md-12 mb4 demo-wrap">
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-8">
									<div class="svg-progress-demo2 demo-item big">
										<span class="svg-progress-output"></span>						
									</div>
									<div class="svg-progress-demo2 demo-item normal">
										<span class="svg-progress-output"></span>						
									</div>
									<div class="svg-progress-demo2 demo-item small">
										<span class="svg-progress-output"></span>						
									</div>
								</div>
								<div class="col-md-4">
									<h2 class="title-plagin">Rhomb <br> proggres example</h2>
									<div class="buttons-wrap mt2">
										<button type="button" class="btn start">start</button>
										<button type="button" class="btn reverse">reverse</button>
										<button type="button" class="btn destroy">destroy</button>
					...
					<div class="col-md-12 mb4 demo-wrap">
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-8">
									<div class="svg-progress-demo3 demo-item big">
										<span class="svg-progress-output"></span>						
									</div>
									<div class="svg-progress-demo3 demo-item normal">
										<span class="svg-progress-output"></span>						
									</div>
									<div class="svg-progress-demo3 demo-item small">
										<span class="svg-progress-output"></span>						
									</div>
								</div>
								<div class="col-md-4">
									<h2 class="title-plagin">Rectangle <br> proggres example</h2>
									<div class="buttons-wrap mt2">
										<button type="button" class="btn start">start</button>
										<button type="button" class="btn reverse">reverse</button>
										<button type="button" class="btn destroy">destroy</button>
					...
					<div class="col-md-12 mb4 demo-wrap">
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-8">
									<div class="svg-progress-demo4 demo-item big">
										<span class="svg-progress-output triangle"></span>
									</div>
									<div class="svg-progress-demo4 demo-item normal">
										<span class="svg-progress-output triangle"></span>
									</div>
									<div class="svg-progress-demo4 demo-item small">
										<span class="svg-progress-output triangle"></span>
									</div>
								</div>
								<div class="col-md-4">
									<h2 class="title-plagin">Triangle <br> proggres example</h2>
									<div class="buttons-wrap mt2">
										<button type="button" class="btn start">start</button>
										<button type="button" class="btn reverse">reverse</button>
										<button type="button" class="btn destroy">destroy</button>
					...
					<div class="col-md-12 mb4 demo-wrap">						
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-8">
									<div class="svg-progress-demo5 demo-item big">
										<span class="svg-progress-output"></span>
									</div>
									<div class="svg-progress-demo5 demo-item normal">
										<span class="svg-progress-output"></span>
									</div>
									<div class="svg-progress-demo5 demo-item small">
										<span class="svg-progress-output"></span>
									</div>
								</div>
								<div class="col-md-4">
									<h2 class="title-plagin">Pentagon <br> proggres example</h2>
									<div class="buttons-wrap mt2">
										<button type="button" class="btn start">start</button>
										<button type="button" class="btn reverse">reverse</button>
										<button type="button" class="btn destroy">destroy</button>
					...
					<div class="col-md-12 mb4 demo-wrap">						
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-8">
									<div class="svg-progress-demo6 demo-item big">
										<span class="svg-progress-output"></span>
									</div>
									<div class="svg-progress-demo6 demo-item normal">
										<span class="svg-progress-output"></span>
									</div>
									<div class="svg-progress-demo6 demo-item small">
										<span class="svg-progress-output"></span>
									</div>
								</div>
								<div class="col-md-4">
									<h2 class="title-plagin">Circle <br> proggres example</h2>
									<div class="buttons-wrap mt2">
										<button type="button" class="btn start">start</button>
										<button type="button" class="btn reverse">reverse</button>
										<button type="button" class="btn destroy">destroy</button>
					...
					<div class="col-md-12 mb4 demo-wrap">						
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-8">
									<div class="svg-progress-demo7 demo-item big"></div>
									<div class="svg-progress-demo8 demo-item big"></div>
									<div class="svg-progress-demo9 demo-item big"></div>
									<div class="svg-progress-demo10 demo-item big"></div>
								</div>
								<div class="col-md-4">
									<h2 class="title-plagin">Svg path <br> proggres example</h2>
									<strong>+</strong>
									<h2 class="title-plagin">Waypoint.js <br> scroll event</h2>
									<div class="buttons-wrap mt2">
										<button type="button" class="btn start">start</button>
										<button type="button" class="btn reverse">reverse</button>
										<button type="button" class="btn destroy">destroy</button>
	...
	$(function(){
		...
		$('.start').on('click', function(){
			$(this).parents('.col-md-12').find('.demo-item').trigger('redraw');			
		});
		$('.reverse').on('click', function(){
			$(this).parents('.col-md-12').find('.demo-item').trigger('reverse');
		});
		$('.destroy').on('click', function(){
			$(this).parents('.col-md-12').find('.demo-item').trigger('destroy');
		});
